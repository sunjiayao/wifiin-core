 ...
 *
 */
public class IpQueryIPIPLocalLibrary implements RemoteQuery{
    
    public IpQueryIPIPLocalLibrary(){}
    ...
    private static final String IP_DAT="/ipip.dat";
    ...
    private static byte[] readDat() throws IOException{
        try(InputStream in=IpQueryIPIPLocalLibrary.class.getResourceAsStream(IP_DAT);
