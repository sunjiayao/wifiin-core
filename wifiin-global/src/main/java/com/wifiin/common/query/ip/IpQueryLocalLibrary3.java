 ...
 *
 */
public class IpQueryLocalLibrary3 implements RemoteQuery{
    
    public IpQueryLocalLibrary3(){
        load();
    }
...
//    private static byte[] indexBuf;
    ...
    private static byte[] readDat() throws IOException{
        try(InputStream in=IpQueryLocalLibrary3.class.getResourceAsStream("/ip.dat");
