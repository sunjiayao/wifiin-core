...
/** 
 * 对象占用字节大小工具类 
 * 把这个类压成jar，在jar的MANIFEST.MF添加以下内容
 * Premain-class: xxx.yyy.zzz.SizeOfObject  
 * Can-Redefine-Classes: false  
 * Boot-Class-Path:  
 * 把这个类所在的jar 执行java -javaagent:PATH_OF_JAR -classpath PATH_OF_CLASSES TestSizeOfObject
 * @author tianmai.fh 
...
public class SizeOfObject {  
    ...
    public static void main(String[] args){
        ...
        System.out.println(sizeOf(new byte[0]));
        System.out.println(sizeOf(new byte[1]));
    }
}